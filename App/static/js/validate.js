           ...
           $.post("/quiz/add_exam/",
               {
                   ...
                   story : document.forms["exam-form"]["story"].value,
               ...
               {
                   //alert(data);
                    $("#exam_list").append(template(document.forms["exam-form"]["user"].value,document.forms["exam-form"]["exam_name"].value, document.forms["exam-form"]["story"].value));
                   $(".add_exam").click();
                   document.forms["exam-form"]["exam_name"].value = "";
                    document.forms["exam-form"]["story"].value = "";
